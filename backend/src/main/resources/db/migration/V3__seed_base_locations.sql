-- Seed Vietnam administrative locations.
-- Source: https://github.com/thanhtrungit97/dvhcvn/tree/main/mysql
-- Mapping: provinces -> cities, wards -> districts.
...
CREATE TEMPORARY TABLE tmp_location_wards (
    ward_code VARCHAR(6) NOT NULL,
    name VARCHAR(255) NOT NULL,
    province_code VARCHAR(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO tmp_location_wards (ward_code, name, province_code)
VALUES
...
INSERT INTO districts (city_id, name, code)
SELECT c.id, w.name, w.ward_code
FROM tmp_location_wards w
JOIN cities c ON c.code = w.province_code;

DROP TEMPORARY TABLE tmp_location_wards;
